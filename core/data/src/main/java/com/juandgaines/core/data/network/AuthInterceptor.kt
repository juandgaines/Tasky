...
class AuthInterceptor @Inject constructor(
    ...
    private val remoteTokenDataSourceProvider: Provider<RemoteTokenDataSource>,
    private val tokenApi: Provider<TokenApi>
): Interceptor {
    ...
    override fun intercept(chain: Chain): Response {
        ...
        runBlocking {
            ...
            if (authData != null) {
                ...
                if (isTokenExpired) {
                    val remoteTokenDataSource = remoteTokenDataSourceProvider.get()

                    safeCall {
                        tokenApi.get().checkAuth()
                    }.onSuccess {
